...
if left_or_right == "left":
    ...
    swim_or_wait = input(
        "Do you wait for a ride, or do you cross the river swimming? "
    ).lower()
    if swim_or_wait == "wait":
        print(
            "You wait until the boat service brings you safely to the other side of the river."
        )
        print(
            "There, you find a cave.\nInside, right in front of you, stand three doors.\nOne red, one blue, and one yellow.\n"
        )
        ...
        if which_door == "red":
            ...
            print(
                "You cross the yellow door. Inside, you see a treasure chest overflowing with gems and gold."
            )
            print("Congratulations, YOU'VE WON!")
        else:
            print(
                "You can't decide, so you spend the rest of your days thinking about it. GAME OVER"
            )
    else:
        print(
            "You're quite impatient, so you decide to swim to the other side of the river."
        )
        print(
            "However, a giant trout attacks you, leading you to your inevitable doom. GAME OVER"
        )
else:
